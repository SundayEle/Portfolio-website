  ...
  return (
    <footer>
      ...
      <div className="footer__socials">
        <a href="https://www.instagram.com/sundayele.code/">
          <GrInstagram />
        </a>
        {/* <a href='https://twitter.com/sunday_ikpabi'><BsTwitter/></a> */}
        <a href="https://web.facebook.com/sundayele.code/">
          <BsFacebook />
        </a>
        <a href="https://www.linkedin.com/in/sunday-ikpabi-608642199/">
          <BsLinkedin />
        </a>
        <a href="https://github.com/SundayEle">
          <BsGithub />
        </a>
      </div>
